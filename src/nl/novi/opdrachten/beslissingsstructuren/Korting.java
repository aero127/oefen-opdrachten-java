...
public class Korting {
    public static void main(String[] args) {
        ...
        if(aankoopBedrag <= 75){
            ...
            System.out.println("De klant krijgt 10% korting. Het aankoopbedrag is nu: " + ((aankoopBedrag/100)*90));
        } else if (aankoopBedrag >= 300.01){
            System.out.println("De klant krijgt 16% korting. Het aankoopbedrag is nu: " + ((aankoopBedrag/100)*84));
        }
